...
namespace TimeTableGenerator {
	...
	public:
		...
		AddStudent(System::Windows::Forms::Form^ frm)
        {
			InitializeComponent();
			dash = frm;
		}
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            this->StudentIDtb = (gcnew System::Windows::Forms::TextBox());
            ...
            this->Passwordtb->TextChanged += gcnew System::EventHandler(this, &AddStudent::textBox2_TextChanged);
            // 
            // Fnametb
            // 
            ...
            // StudentIDtb
            // 
            this->StudentIDtb->Location = System::Drawing::Point(477, 114);
            this->StudentIDtb->Name = L"StudentIDtb";
            this->StudentIDtb->Size = System::Drawing::Size(200, 22);
            ...
            this->Load += gcnew System::EventHandler(this, &AddStudent::AddTeacher_Load);
...
#pragma endregion
    ...
    private: System::Void saveButton_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        try {
            ...
            checkcmd->Parameters->AddWithValue("@StudentID", StudentIDtb->Text);
            int count = (int)checkcmd->ExecuteScalar();

            if (count > 0) {
                MessageBox::Show("Student ID already exists", "Error", MessageBoxButtons::OK, MessageBoxIcon::Warning);
                return;
            }
            else {
                String^ query = "INSERT INTO [Student] (StudentID,FirstName,LastName,Email) VALUES (@StudentID, @FirstName, @LastName, @Email)";

                SqlCommand^ cmd = gcnew SqlCommand(query, conn);

                cmd->Parameters->AddWithValue("@StudentID", StudentIDtb->Text);
                ...
                add->Parameters->AddWithValue("@UserType", "Student");
                add->Parameters->AddWithValue("@ForeignID", "@StudentID");
                add->ExecuteNonQuery();
            ...
            MessageBox::Show("Failed to add " + Fnametb->Text + "  sql Error " + ex->Message, "Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
        }
        catch (Exception^ ex) {
            MessageBox::Show("Failed to add "+ Fnametb->Text+" " + ex->Message, "Error", MessageBoxButtons::OK, MessageBoxIcon::Error);
        }
        finally {
            conn->Close();
        }
